package dev.akshaj.continuum.entity.client;
...
public class TomahawkProjectileModel extends EntityModel<EntityRenderState> {
    public static final EntityModelLayer TOMAHAWK = new EntityModelLayer(Identifier.of(Continuum.MOD_ID, "tomahawk"), "main");
