...
public class SulphurFlameParticle extends BillboardParticle {
    public SulphurFlameParticle(ClientWorld clientWorld, double x, double y, double z,
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z,
            ...
            return new SulphurFlameParticle(world, x, y, z, this.spriteProvider, velocityX, velocityY, velocityZ);
        }
    }
}